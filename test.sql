...
CREATE TABLE KAMIKAZE (
    ...
    CONSTRAINT CK_KAMIKAZE_ALTURA CHECK (ALTURA_MAX IS NULL OR ALTURA_MAX >= ALTURA_MIN)
);
...
CREATE TABLE TOURO_MECANICO (
    ...
    CONSTRAINT CK_TOURO_MECANICO CHECK (ALTURA_MAX IS NULL OR ALTURA_MAX >= ALTURA_MIN)
);
